				...
				<div class="card min-card-height">
					<div class="card-title">
						...
						<Popper 
							...
							placement="right" 
							class="fs11" 
							content="Adjust settings for the automatic email system"
						>
					...
					<div class="card-body">
						<p class="bold mb20">
							...
							>
								<i 
									...
									@click="add_emailer_modal_open = true"
								></i>
							</Popper>
						</p>
						...
						<input 
							type="email" 
							class="form-control max-width-400 mt20" 
							placeholder="Email" 
							v-model="reinstatement_contact"
						>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveReinstatementContact"
							>
								Save
							</button>
						</div>
						...
						<input 
							...
							v-model="enabled_letter_uploaded"
						>
						<label 
							for="letter-uploaded" 
							class="ml5 pointer fs14 op8"
						>
							User uploads a letter
						</label>
						<textarea 
							:disabled="loading.email_letter_uploaded" 
							v-model="email_letter_uploaded" 
						...
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_letter_uploaded', email_letter_uploaded)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_letter_uploaded" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						</div>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_kyc_needs_review"
						>
						<label 
							for="kyc-needs-review" 
							class="ml5 pointer fs14 op8"
						>
							KYC or AML needs review
						</label>
						<textarea 
							:disabled="loading.email_kyc_needs_review" 
							v-model="email_kyc_needs_review" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_kyc_needs_review }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_kyc_needs_review', email_kyc_needs_review)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_kyc_needs_review" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<textarea 
							:disabled="loading.email_welcome" 
							v-model="email_welcome" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_welcome }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_welcome', email_welcome)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_welcome" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_node_verified"
						>
						<label 
							for="node-is-verified" 
							class="ml5 pointer fs14 op8"
						>
							Your Node is Verified
						</label>
						<textarea 
							:disabled="loading.email_node_verified" 
							v-model="email_node_verified" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_node_verified }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_node_verified', email_node_verified)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_node_verified" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_letter_received"
						>
						<label 
							for="letter-received" 
							class="ml5 pointer fs14 op8"
						>
							Your letter of motivation is received. Member has completed all onboarding steps.
						</label>
						<textarea 
							:disabled="loading.email_letter_received" 
							v-model="email_letter_received" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_letter_received }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_letter_received', email_letter_received)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_letter_received" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_letter_approved"
						>
						<label 
							for="letter-approved" 
							class="ml5 pointer fs14 op8"
						...
						<textarea 
							:disabled="loading.email_letter_approved" 
							v-model="email_letter_approved" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_letter_approved }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_letter_approved', email_letter_approved)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_letter_approved" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_letter_denied"
						>
						<label 
							for="letter-denied" 
							class="ml5 pointer fs14 op8"
						>
							Your letter of motivation is denied
						</label>
						<textarea 
							:disabled="loading.email_letter_denied" 
							v-model="email_letter_denied" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_letter_denied }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_letter_denied', email_letter_denied)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_letter_denied" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<textarea 
							:disabled="loading.email_new_perk" 
							v-model="email_new_perk" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_new_perk }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_new_perk', email_new_perk)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_new_perk" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<textarea 
							:disabled="loading.email_vote_started" 
							v-model="email_vote_started" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_vote_started }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_vote_started', email_vote_started)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_vote_started" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<textarea 
							:disabled="loading.email_vote_reminder" 
							v-model="email_vote_reminder" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_vote_reminder }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_vote_reminder', email_vote_reminder)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_vote_reminder" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_probation"
						>
						<label 
							for="probation" 
							class="ml5 pointer fs14 op8"
						>
							User goes on probation
						</label>
						<textarea 
							:disabled="loading.probation" 
							v-model="email_probation" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_probation }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_probation', email_probation)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.probation" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_revoked"
						>
						<label 
							for="revoked" 
							class="ml5 pointer fs14 op8"
						>
							User membership gets revoked
						</label>
						<textarea 
							:disabled="loading.email_revoked" 
							v-model="email_revoked" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_revoked }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_revoked', email_revoked)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_revoked" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
						...
						<input 
							...
							type="checkbox" 
							class="form-check-input pointer mt5" 
							v-model="enabled_warning"
						>
						<label 
							for="warning" 
							class="ml5 pointer fs14 op8"
						>
							User membership gets a warning
						</label>
						<textarea 
							:disabled="loading.email_warning" 
							v-model="email_warning" 
							class="form-control height-200 p15 mt10"
						>
							{{ email_warning }}
						</textarea>
						<div class="form-group mt10 mb40">
							<button 
								class="btn btn-success" 
								@click="saveEmailContent('email_warning', email_warning)"
							>
								Save
							</button>
							<ClipLoader 
								v-if="loading.email_warning" 
								size="25px" 
								color="#ff2d2e" 
								class="clip-loader-inline ml10"
							></ClipLoader>
